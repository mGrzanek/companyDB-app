...
describe('Department', () => {
    ...
    describe('Reading data', () => {
        ...
        it('should proper document by "name" with "findOne" method', async () => {
            const department = await Department({ name: 'Department #1'});
    ...
    describe('Updating data', () => {
        ...
        it('should properly update multiple documents with "updateMany" method', async () => {
            ...
            const departments = await Department.find({ name: 'Updated department!' });
    ...
    describe('Removing data', () => {
        ...
        it('should properly remove many documents with "deleteMany" method', async () => {
            await Department.deleteMany();
            const departments = await Department.find();
